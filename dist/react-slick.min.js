...
*/ !(function() {
      ...
      function(e, t, n) {
        ...
        (function(e) {
          ...
          var E = void 0 !== i.ResizeObserver ? i.ResizeObserver : _;
          t.a = E;
        }.call(this, n(4)));
      },
      function(e, t) {
      ...
      function(e, t, n) {
        ...
        function h(e) {
          for (var t = [], n = k(e), r = T(e), i = n; i < r; i++)
          ...
          return (
            e.infinite ||
              (((e.centerMode && e.currentSlide >= e.slideCount - 1) ||
                ...
                (!e.rtl && e.currentSlide >= e.slideCount - e.slidesToShow) ||
                (e.rtl && e.currentSlide + 1 >= e.slideCount)) &&
                (t = !1)),
            t
          );
        }
        ...
        var k = function(e) {
          ...
          P = function(e) {
            ...
            if (
              ...
              if (
                ((m = i + C(e)),
                (n = (r = S && S.childNodes[m]) ? -1 * r.offsetLeft : 0),
                !0 === l)
              ) {
                (m = a ? i + C(e) : i), (r = S && S.children[m]);
                for (var O = (n = 0); O < m; O++)
                  n -= S && S.children[O] && S.children[O].offsetWidth;
                (n -= parseInt(e.centerPadding)),
                  (n += r && (f - r.offsetWidth) / 2);
              }
            }
            return n;
          },
          ...
          z = function(e) {
            return 1 === e.slideCount ? 1 : C(e) + e.slideCount + S(e);
          },
          W = function(e) {
        ...
        var ce = (function() {
            function e() {
              return re(this, e), se(this, ae(e).apply(this, arguments));
            }
            return (
              le(e, i.a.PureComponent),
              oe(e, [
                {
                  key: "clickHandler",
                  value: function(e, t) {
                  ...
                  value: function() {
                    ...
                    !this.props.infinite &&
                      (this.props.slideCount <= this.props.slidesToShow ||
                        (!this.props.rtl && 0 === this.props.currentSlide) ||
                        (this.props.rtl &&
                          0 <
                    ...
                    return this.props.prevArrow
                      ? i.a.cloneElement(this.props.prevArrow, te({}, n, r))
                      : i.a.createElement(
                          "button",
                          ee({ key: "0", type: "button" }, n),
                          " ",
                          "Previous"
                        );
                  }
              ...
              oe(e, [
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    g(this.props) || ((e["slick-disabled"] = !0), (t = null));
                    var n = {
                        key: "1",
                        "data-role": "none",
                        className: d()(e),
                    ...
                    return this.props.nextArrow
                      ? i.a.cloneElement(this.props.nextArrow, te({}, n, r))
                      : i.a.createElement(
                          "button",
                          ee({ key: "1", type: "button" }, n),
                          " ",
                          "Next"
                        );
                  }
              ...
              return (
                ...
                ge(
                  ye(
                    (n = (function(e, t) {
                      return !t ||
                        ("object" !== fe(t) && "function" != typeof t)
                        ? ye(e)
                        : t;
                    })(this, ve(e).call(this, t)))
                  ),
                  "listRefHandler",
                  function(e) {
                    return (n.list = e);
                ...
                ge(ye(n), "trackRefHandler", function(e) {
                  return (n.track = e);
                }),
                ge(ye(n), "adaptHeight", function() {
                  if (n.props.adaptiveHeight && n.list) {
                    var e = n.list.querySelector(
                      '[data-index="'.concat(n.state.currentSlide, '"]')
                    );
                    n.list.style.height = y(e) + "px";
                  }
                }),
                ge(ye(n), "componentWillMount", function() {
                  if (
                    (n.ssrInit(),
                    n.props.onInit && n.props.onInit(),
                    n.props.lazyLoad)
                  ) {
                    var e = h(he({}, n.props, n.state));
                    0 < e.length &&
                ...
                ge(ye(n), "componentDidMount", function() {
                  var e = he({ listRef: n.list, trackRef: n.track }, n.props);
                ...
                ge(ye(n), "componentWillUnmount", function() {
                ...
                ge(ye(n), "componentWillReceiveProps", function(e) {
                  for (
                    var t = he(
                ...
                ge(ye(n), "componentDidUpdate", function() {
                  if (
                    (n.checkImagesLoad(),
                ...
                ge(ye(n), "onWindowResized", function(e) {
                ...
                ge(ye(n), "updateState", function(e, t, r) {
                  var o = (function(e) {
                    var t,
                    ...
                    var d = e.lazyLoadedList || [],
                      p = h({ currentSlide: u, lazyLoadedList: d });
                    d.concat(p);
                    var f = {
                      slideCount: n,
                      slideWidth: t,
                  ...
                  e = he(
                    {},
                    (e = he({}, e, o, { slideIndex: o.currentSlide })),
                    { left: P(e) }
                  );
                  var a = M(e);
                  (!t &&
                ...
                ge(ye(n), "ssrInit", function() {
                  if (n.props.variableWidth) {
                    ...
                    var p = i.a.Children.count(n.props.children),
                      f = he({}, n.props, n.state, { slideCount: p }),
                      h = C(f) + S(f) + p,
                      v = (100 / n.props.slidesToShow) * h,
                      y = 100 / h,
                      b = (-y * (C(f) + n.state.currentSlide) * v) / 100;
                    n.props.centerMode && (b += (100 - (y * v) / 100) / 2);
                    var g = { width: v + "%", left: b + "%" };
                    n.setState({ slideWidth: y + "%", trackStyle: g });
                  }
                }),
                ge(ye(n), "checkImagesLoad", function() {
                ...
                ge(ye(n), "progressiveLazyLoad", function() {
                  for (
                    var e = [],
                      t = he({}, n.props, n.state),
                      r = n.state.currentSlide;
                    r < n.state.slideCount + S(t);
                    r++
                  )
                  ...
                  for (var i = n.state.currentSlide - 1; i >= -C(t); i--)
                ...
                ge(ye(n), "slideHandler", function(e) {
                  var t =
                      1 < arguments.length &&
                      void 0 !== arguments[1] &&
                      arguments[1],
                      ...
                      if (r) {
                        ...
                        (y = w) < 0
                          ...
                          : s <= w &&
                            ((y = w - s),
                            i ? s % d != 0 && (y = 0) : (y = s - f)),
                          (b = P(p({}, e, { slideIndex: w }))),
                          (m = P(p({}, e, { slideIndex: y }))),
                          i || (b === m && (w = y), (b = m)),
                          l && a.concat(h(p({}, e, { currentSlide: w }))),
                          v
                            ? (O = {
                                animating: !(S = {
                                  animating: !0,
                                  currentSlide: y,
                                  trackStyle: j(p({}, e, { left: b })),
                                  lazyLoadedList: a
                                }),
                                currentSlide: y,
                                trackStyle: M(p({}, e, { left: m })),
                                swipeLeft: null
                              })
                            : (S = {
                                currentSlide: y,
                  ...
                  if (d) {
                    ...
                    var v = d.lazyLoadedList.filter(function(e) {
                ...
                ge(ye(n), "changeSlide", function(e) {
                  var t =
                      1 < arguments.length &&
                      void 0 !== arguments[1] &&
                      arguments[1],
                    r = (function(e, t) {
                      ...
                      if (
                        ...
                        return null;
                      return o;
                    })(he({}, n.props, n.state), e);
                  (0 !== r && !r) ||
                    (!0 === t ? n.slideHandler(r, t) : n.slideHandler(r));
                }),
                ge(ye(n), "clickHandler", function(e) {
                  !1 === n.clickable &&
                    (e.stopPropagation(), e.preventDefault()),
                    (n.clickable = !0);
                }),
                ge(ye(n), "keyHandler", function(e) {
                ...
                ge(ye(n), "selectHandler", function(e) {
                  n.changeSlide(e);
                }),
                ge(ye(n), "disableBodyScroll", function() {
                ...
                ge(ye(n), "enableBodyScroll", function() {
                  window.ontouchmove = null;
                }),
                ge(ye(n), "swipeStart", function(e) {
                ...
                ge(ye(n), "swipeMove", function(e) {
                  var t = (function(e, t) {
                    ...
                    if (!n) {
                      ...
                      if (!s && !h && 10 < x) return { scrolling: !0 };
                      s && (w.swipeLength = x);
                      var L = (a ? -1 : 1) * (w.curX > w.startX ? 1 : -1);
                ...
                ge(ye(n), "play", function() {
                  var e;
                  if (n.props.rtl)
                    e = n.state.currentSlide - n.props.slidesToScroll;
                  else {
                    if (!g(he({}, n.props, n.state))) return !1;
                    e = n.state.currentSlide + n.props.slidesToScroll;
                  }
                  n.slideHandler(e);
                }),
                ge(ye(n), "autoPlay", function(e) {
                  n.autoplayTimer && clearInterval(n.autoplayTimer);
                ...
                ge(ye(n), "onDotsOver", function() {
                  return n.props.autoplay && n.pause("hovered");
                }),
                ge(ye(n), "onDotsLeave", function() {
                  return (
                    n.props.autoplay &&
                ...
                ge(ye(n), "onTrackOver", function() {
                  return n.props.autoplay && n.pause("hovered");
                }),
                ge(ye(n), "onTrackLeave", function() {
                  return (
                    n.props.autoplay &&
                    "hovered" === n.state.autoplaying &&
                    n.autoPlay("leave")
                ...
                ge(ye(n), "onSlideFocus", function() {
                  return n.props.autoplay && n.pause("focused");
                }),
                ge(ye(n), "onSlideBlur", function() {
                  return (
                    n.props.autoplay &&
                ...
                ge(ye(n), "render", function() {
                  ...
                  (p.clickHandler = n.changeSlide),
                    n.props.arrows &&
                      ((t = i.a.createElement(ce, p)),
                      (r = i.a.createElement(ue, p)));
                  var f = null;
                  ...
                  return (
                    ...
                    i.a.createElement(
                      ...
                      i.a.createElement(
                        "div",
                        pe({ ref: n.listRefHandler }, b),
                        i.a.createElement(
                          G,
                          pe({ ref: n.trackRefHandler }, a),
                          n.props.children
                        )
                      ),
                      n.props.unslick ? "" : r,
              ...
              return (
                ...
                je(
                  Le(
                    (n = (function(e, t) {
                      return !t ||
                        ("object" !== ke(t) && "function" != typeof t)
                        ? Le(e)
                        : t;
                    })(this, xe(e).call(this, t)))
                  ),
                ...
                je(Le(n), "slickPrev", function() {
                  return n.innerSlider.slickPrev();
                }),
                je(Le(n), "slickNext", function() {
                  return n.innerSlider.slickNext();
                }),
                je(Le(n), "slickGoTo", function(e) {
                  var t =
                    1 < arguments.length &&
                    void 0 !== arguments[1] &&
                    arguments[1];
                ...
                je(Le(n), "slickPause", function() {
                  return n.innerSlider.pause("paused");
                }),
                je(Le(n), "slickPlay", function() {
                    ...
                    if (this.props.responsive) {
                      ...
                      t.sort(function(e, t) {
                        ...
                        t.forEach(function(n, r) {
                          ...
                          (i =
                            0 === r
                              ? Se()({ minWidth: 0, maxWidth: n })
                              : Se()({ minWidth: t[r - 1] + 1, maxWidth: n })),
                            O() &&
                              e.media(i, function() {
                                e.setState({ breakpoint: n });
                              });
                        });
                      var n = Se()({ minWidth: t.slice(-1)[0] });
                      O() &&
                ...
                },
                {
                  ...
                  value: function() {
                    this._responsiveMediaHandlers.forEach(function(e) {
                      Pe.unregister(e.query, e.handler);
                    });
                  }
                },
                {
                  ...
                  value: function() {
                    ...
                    (e = this.state.breakpoint
                      ? "unslick" ===
                        ...
                        ? "unslick"
                        : _e({}, Oe, this.props, t[0].settings)
                      : _e({}, Oe, this.props)).centerMode &&
                    ...
                    if ("unslick" !== e)
                      return (
                        ...
                        i.a.createElement(
                          me,
                          Te({ ref: this.innerSliderRefHandler }, e),
                          o
                        )
                      );
